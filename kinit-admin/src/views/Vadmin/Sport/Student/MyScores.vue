...
<template>
  <ContentWrap>
    <ElCard v-if="isStaff" shadow="never" class="mb-12px" header="筛选条件">
    ...
    <div v-if="loading" class="text-center py-32px text-gray-400">正在加载成绩数据...</div>
    ...
    <div v-else class="my-scores-page">
      <ElCard shadow="never" class="mb-12px" header="个人档案">
      ...
      <ElRow :gutter="12" class="mb-12px">
        <ElCol :xs="24" :sm="12">
          <ElCard shadow="hover" class="kpi-card">
            <ElStatistic title="最新体考总分" :value="peLatestScore" />
          </ElCard>
        </ElCol>
        <ElCol :xs="24" :sm="12">
          <ElCard shadow="hover" class="kpi-card">
            <ElStatistic title="最新体测综合评分" :value="fitnessLatestScore" />
          </ElCard>
        </ElCol>
      </ElRow>

      <ElCard shadow="never" class="mb-12px" header="体考分析（3图）">
        <ElRow :gutter="12">
      ...
      <ElCard shadow="never" class="mb-12px" header="体测分析（3图）">
        <ElRow :gutter="12">
          <ElCol :xs="24" :md="8" class="mb-12px">
      ...
      <ElRow :gutter="12">
        <ElCol :xs="24" :lg="12" class="mb-12px">
          <ElCard shadow="never" header="体考成绩明细">
