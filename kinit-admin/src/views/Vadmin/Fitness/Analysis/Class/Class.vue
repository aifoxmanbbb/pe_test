...
import { exportFitnessReportApi, getFitnessBatchOptionsApi, getFitnessClassAnalysisApi } from '@/api/vadmin/fitness'
...
const handleExport = () => {
  openScoreReport(exportFitnessReportApi, lastParams.value, '体测')
}
